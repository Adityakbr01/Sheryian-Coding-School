...
export const aiController = {
    chat: catchAsync(async (req: any, res: Response) => {
    ...
    getChats: catchAsync(async (req: any, res: Response) => {
        const authReq = req as AuthRequest;
        const userId = authReq.user!.id;
    ...
    getChatMessages: catchAsync(async (req: any, res: Response) => {
        const authReq = req as AuthRequest;
    ...
    getHistory: catchAsync(async (req: any, res: Response) => {
        // Legacy fallback
        const authReq = req as AuthRequest;
        const userId = authReq.user!.id;
        try {
